...
|---|---|---|---|
| [azure-devops](azure-devops/) | Azure DevOps | REST API, pinned `api-version` ([ADR 0005](../docs/adr/0005-azure-devops-adapter-calls-the-rest-api-directly.md)) | In progress (Phase 1): work item reads and queries |
