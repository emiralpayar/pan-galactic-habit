...
2. **Gather the facts** before writing: the problem, constraints, the options genuinely considered, and who made the decision. If the user has not made the decision yet, write the ADR with status `Proposed` and present the options — do not decide on their behalf.
...
5. **Add it to the index** in `docs/adr/README.md`.
